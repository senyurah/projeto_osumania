...
def run_options(screen) -> None:
    ...
    def render():
        ...
        W, H = screen.get_size()
        title = font.render("Opções", True, (240,240,240))
        ...
        # tooltip
        help_lines = {
            0: "Volume geral da musica 0–100",
            1: "Liga e desliga background durante gameplay",
            2: "Compensa atraso entre audio/visual e sua tecla",
            3: "Grava em dados/settings_user.json",
            4: "Volta ao menu anterior sem salvar"
        }[idx]
        h = small.render(help_lines, True, (220,220,220))
        ...
        for ev in pygame.event.get():
            ...
            if ev.type == pygame.KEYDOWN:
                ...
                if ev.key in (pygame.K_UP, pygame.K_w):
                    ...
                    if idx == 0:
                        volume_pct = min(100, volume_pct + 5)
                    elif idx == 1:
                        bg_video = not bg_video
                    elif idx == 2:
                        latency_ms += 5
